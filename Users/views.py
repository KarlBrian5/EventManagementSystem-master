...
username = 'YobraEvent'
api_key = '2216b1de3aa04299351aa8c769b1c031cfb7a9ee8e3f49564cbff2e1d6e674a6'
...
def event_report(request):
    ...
    response = HttpResponse(render_to_pdf, content_type='application/pdf')
    response['Content-Disposition'] = 'attachment; filename=Events_List.pdf'
    for viewevent in guest_view_events:
